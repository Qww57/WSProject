...
public class SearchOutputRepresentation {
    ...
    public static class SearchHotelOutputRepresentation {
        public List<SearchHotelInformationOutputRepresentation> hotelsInformationList = new ArrayList<SearchHotelInformationOutputRepresentation>();
        
        
        @XmlRootElement
        public static class SearchHotelInformationOutputRepresentation {
            private SearchedHotel hotel;
            private String BookingNumber;
            private Integer Price;
            private String ReservationService;
            //constructor
            public SearchHotelInformationOutputRepresentation() {
            }
            //getters and setters
    ...
    public static class SearchFlightOutputRepresentation {
        public List<SearchFlightInformationOutputRepresentation> flightsInformationList = new ArrayList<SearchFlightInformationOutputRepresentation>();
        
    
        @XmlRootElement
        public static class SearchFlightInformationOutputRepresentation {
            private String BookingNumber;
            private Integer Price;
            private String AirlineReservationService;
            private SearchedFlight Flight;
            //constructor
            public SearchFlightInformationOutputRepresentation() {
            }
            //getters and setters
            public void setBookingNumber(String BookingNumber) {
                this.BookingNumber = BookingNumber;
